...
export function Starfield() {
  ...
  return (
    ...
    >
      ...
      {/* Star layers */}
      <div className="absolute inset-0 stars-layer-1 stars-parallax" />
      <div className="absolute inset-0 stars-layer-2 stars-parallax" />
      <div className="absolute inset-0 stars-layer-3 stars-parallax" />
